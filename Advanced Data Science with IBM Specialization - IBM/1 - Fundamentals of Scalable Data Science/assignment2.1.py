...
host = 'a2a9fd09-3bd8-4640-9816-8cdfa07f3b27-bluemix.cloudant.com'
username = 'a2a9fd09-3bd8-4640-9816-8cdfa07f3b27-bluemix'
password = 'f7e9f00942e8bb36326a331beb63414fd9053b4be5b9a2b56ce1047bb55b2afd'
...
spark = SparkSession    .builder    .appName("Cloudant Spark SQL Example in Python using temp tables")    .config("cloudant.host", host)    .config("cloudant.username", username)    .config("cloudant.password", password)    .config("jsonstore.rdd.partitions", 1)    .getOrCreate()
